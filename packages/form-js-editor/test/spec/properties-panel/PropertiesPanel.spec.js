      ...
      describe('validation', function() {
        ...
        describe('key', function() {
          ...
          it('should show error key empty', function() {
            ...
            const error = screen.getByText('Key must not be empty.');
          ...
          it('should show error if key contains spaces', function() {
            ...
            const error = screen.getByText('Key must not contain spaces.');
          ...
          it('should show error if key is not unique', function() {
            ...
            const error = screen.getByText('Key must be unique.');
